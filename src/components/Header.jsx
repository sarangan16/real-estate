...
const Header = () => {
  return (
    <div
      ...
      style={{ backgroundImage: "url('/head_img.jpg')" }}
      id="Header"
    >
      <Navbar />
      ...
      >
        <h1 className="text-5xl sm:text-6xl md:text-[82px] inline-block max-w-3xl font-semibold pt-20">
          Verwirklichen Sie Ihr Traumhaus an Ihrem Wunschstandort.
        </h1>
        <div className="space-x-6 mt-16">
          ...
          <a
            href="#Contact"
            className="bg-blue-500 text-white px-8 py-3 rounded sm:px-8"
          >
